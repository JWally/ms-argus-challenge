import type { EmbedPhase } from './embed-presentation.js';

const stroke = { fill: 'none', stroke: 'currentColor' } as const;

export function EyeMark() {
  return (
    <svg className="ax-eye" viewBox="0 0 24 24" strokeWidth="2" aria-hidden="true" {...stroke}>
...
export function MonitorIcon() {
  return (
    <svg viewBox="0 0 24 24" strokeWidth="1.8" aria-hidden="true" {...stroke}>
...
export function EmbedSeal({ phase }: { phase: EmbedPhase }) {
  ...
  return (
    <svg className="ax-ring" viewBox="0 0 48 48" strokeWidth="2.4" aria-hidden="true" {...stroke}>
