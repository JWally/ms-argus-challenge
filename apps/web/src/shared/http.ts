...
const COPY: Readonly<Record<string, string>> = {
  ...
  sso_requires_phone: 'Mobile SSO must be opened on a phone.',
  phone_required: 'Mobile SSO must stay on the same phone.',
  proof_of_life_required: 'Choose a verification method to continue.',
